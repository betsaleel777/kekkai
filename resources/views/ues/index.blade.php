...
@endsection
@section('content')
<h2 class="ui dividing header">LISTE DES UNITES D'ENSEIGNEMENT (UE)</h2>
           ...
           @forelse ($ues as $ue)
             <tr>
                 ...
                 <td>
                     ...
                     <a href="{{route('ues_delete',$ue)}}"><i class="large trash alternate icon"></i></a>
                     <a href="{{route('ues_show',$ue)}}"><i class="large crosshairs icon"></i></a>
                 </td>
             </tr>
           @empty
             <tr>
